...
<div align="center">
  <img src="./public/logo.svg" alt="DynastyLoom — Crusader Kings III — Inheritance" width="64" height="64">
  <h1>DynastyLoom — Crusader Kings III — Inheritance</h1>
</div>

An independent project specification for Crusader Kings III, covering dynasty resource sheets, succession scenario comparisons, game rule snapshots.
...
<img src="./public/screenshots/desktop-main.svg" alt="Crusader Kings III — desktop concept, not a screenshot" width="520">
<br>
<em>Three proposed modules, not implemented features</em>
</td>
<td align="center">
<h3>Compact Concept</h3>
<img src="./public/screenshots/mobile-overview.svg" alt="Crusader Kings III — compact concept, not a screenshot" width="250">
<br>
...
- **Dynasty resource sheets** — planned module; not implemented.
- **Succession scenario comparisons** — planned module; not implemented.
- **Game rule snapshots** — planned module; not implemented.

The proposed workflow separates dynasty resource sheets from succession scenario comparisons, with game rule snapshots retained for reproducibility. These are design goals, not claims about existing functionality.
...
3. Describe one baseline scenario for **Dynasty resource sheets**.
...
<div align="center">
<img src="./public/screenshots/review-workflow.svg" width="700" alt="DynastyLoom — Crusader Kings III — Inheritance — specification review workflow">
<br>
...
### Dynasty resource sheets

Define the input and expected outcome for module 1. Record the Crusader Kings III version, scenario conditions, and known limitations. Completing these notes manually does not establish that an automated tool exists.

### Succession scenario comparisons

Define the input and expected outcome for module 2. Record the Crusader Kings III version, scenario conditions, and known limitations. Completing these notes manually does not establish that an automated tool exists.

### Game rule snapshots

Define the input and expected outcome for module 3. Record the Crusader Kings III version, scenario conditions, and known limitations. Completing these notes manually does not establish that an automated tool exists.

### At a glance

| Field | Value |
|---|---|
| Target | Crusader Kings III |
| Category | Offline game project |
| Input | Manual notes or user-authorized local exports |
| Planned output | Dynasty resource sheets |
