...
独立的项目设计文档，适用对象： **Crusader Kings III**。
...
- **王朝资源表** (Dynasty resource sheets) — 规划模块，尚未实现。
- **继承场景比较** (Succession scenario comparisons) — 规划模块，尚未实现。
- **游戏规则快照** (Game rule snapshots) — 规划模块，尚未实现。
